...
public class Admin1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewArtists = (ListView) findViewById(R.id.listViewArtists1);

        buttonAddArtist = (Button) findViewById(R.id.buttonAddArtist1);
    ...
    private void addArtist() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            Toast.makeText(this, "Please enter a Class", Toast.LENGTH_LONG).show();
        }
    }
    ...
    protected void onStart() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                Facultylist facultylist = new Facultylist(Admin1.this, facultys);
    ...
    private void showUpdateDeleteDialog(final String Id, String Name) {
        ...
        final View dialogView = inflater.inflate(R.layout.dialog1, null);
        dialogBuilder.setView(dialogView);

        final EditText editTextName = (EditText) dialogView.findViewById(R.id.editTextName1);
    ...
    private boolean updateArtist(String id, String name) {
        ...
        DatabaseReference dR = FirebaseDatabase.getInstance().getReference("class").child(id);
